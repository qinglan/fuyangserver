...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(default='扶阳医学', max_length=256, verbose_name='站点名称')),
                ('text_1', models.CharField(max_length=256, verbose_name='站点关键字')),
                ('text_2', models.CharField(max_length=256, verbose_name='站点描述')),
                ('image', models.ImageField(upload_to='image', verbose_name='主页图标 500x100 px')),
                ('background', models.ImageField(default='image/title_bg.png', upload_to='image', verbose_name='背景图片')),
                ('wordsclean', models.TextField(blank=True, help_text='使用,|;分隔', max_length=256, verbose_name='评论内容过虑')),
            ],
            options={
                'verbose_name': '站点信息配置',
                'verbose_name_plural': '站点信息配置',
            },
        ),
        migrations.CreateModel(
            name='SinglePage',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=256, verbose_name='标题')),
                ('image', models.ImageField(null=True, upload_to='image', verbose_name='封面 480x270 px')),
                ('pub_date', models.DateTimeField(default=django.utils.timezone.now, editable=False, verbose_name='创建时间')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('count', models.IntegerField(default=0, verbose_name='课程数')),
                ('sequeue', models.IntegerField(default=9999, verbose_name='排序')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('play_id', models.CharField(blank=True, default='', max_length=256, null=True, verbose_name='录播视频文件ID')),
                ('play_app_id', models.CharField(blank=True, default='1257252657', max_length=256, null=True, verbose_name='录播视频appID')),
                ('image', models.ImageField(null=True, upload_to='image', verbose_name='封面 304x171 px')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('live_image', models.CharField(blank=True, default='', max_length=256, null=True, verbose_name='当前直播显示的图片')),
                ('image_show_time', models.TextField(blank=True, default='', null=True, verbose_name='图片显示时间')),
                ('speaking', models.BooleanField(default=True, verbose_name='是否可以发言')),
            ],
            options={
                'verbose_name': 'a3直播计划',
        ...
        migrations.AddField(
            model_name='videoinfostudyfuyangcomment',
            name='ascription',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='study.VideoInfoStudyFuyang', verbose_name='所属视频'),
        ),
        migrations.AddField(
            model_name='videoinfolecturecomment',
            name='ascription',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='study.VideoInfoLecture', verbose_name='所属视频'),
        ),
        migrations.AddField(
