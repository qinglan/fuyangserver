...
class PictureTextColumn1(models.Model):
    name = models.CharField('图文栏目名称', max_length=256)
    ...
    class Meta:
        verbose_name = '图文栏目1'
        verbose_name_plural = '图文栏目1'
        ordering = ['pk']

class PictureTextColumn2(models.Model):
    name = models.CharField('图文栏目名称', max_length=256)
    ...
    class Meta:
        verbose_name = '图文栏目2'
        verbose_name_plural = '图文栏目2'
        ordering = ['pk']

class PictureTextColumn3(models.Model):
    name = models.CharField('图文栏目名称', max_length=256)
    ...
    class Meta:
        verbose_name = '图文栏目3'
        verbose_name_plural = '图文栏目3'
        ordering = ['pk']

class PictureTextColumn4(models.Model):
    name = models.CharField('图文栏目名称', max_length=256)
...
class PictureTextPaper1(models.Model):
    name = models.CharField('图文标题', max_length=256)
    ...
    class Meta:
        verbose_name = '图文文章1'
        verbose_name_plural = '图文文章1'

class PictureTextPaper2(models.Model):
    name = models.CharField('图文标题', max_length=256)
    ...
    class Meta:
        verbose_name = '图文文章2'
        verbose_name_plural = '图文文章2'

class PictureTextPaper3(models.Model):
    name = models.CharField('图文标题', max_length=256)
    ...
    class Meta:
        verbose_name = '图文文章3'
        verbose_name_plural = '图文文章3'

class PictureTextPaper4(models.Model):
    name = models.CharField('图文标题', max_length=256)
...
class PictureTextPaperComment1(models.Model):
    message = models.CharField('图文评论', max_length=256)
    ascription = models.ForeignKey(PictureTextPaper, on_delete=models.CASCADE, blank=True, verbose_name='所属图文')
    register_date = models.DateTimeField('评论时间', auto_now_add=True, editable=False)
    author = models.ForeignKey(User, on_delete=models.CASCADE, blank=True, verbose_name='作者')
    ...
    class Meta:
        verbose_name = '图文评论1'
        verbose_name_plural = '图文评论1'
        ordering = ['-register_date']

class PictureTextPaperComment2(models.Model):
    message = models.CharField('图文评论', max_length=256)
    ascription = models.ForeignKey(PictureTextPaper, on_delete=models.CASCADE, blank=True, verbose_name='所属图文')
    register_date = models.DateTimeField('评论时间', auto_now_add=True, editable=False)
    author = models.ForeignKey(User, on_delete=models.CASCADE, blank=True, verbose_name='作者')
    ...
    class Meta:
        verbose_name = '图文评论2'
        verbose_name_plural = '图文评论2'
        ordering = ['-register_date']

class PictureTextPaperComment3(models.Model):
    message = models.CharField('图文评论', max_length=256)
    ascription = models.ForeignKey(PictureTextPaper, on_delete=models.CASCADE, blank=True, verbose_name='所属图文')
    register_date = models.DateTimeField('评论时间', auto_now_add=True, editable=False)
    author = models.ForeignKey(User, on_delete=models.CASCADE, blank=True, verbose_name='作者')
    ...
    class Meta:
        verbose_name = '图文评论3'
        verbose_name_plural = '图文评论3'
        ordering = ['-register_date']

class PictureTextPaperComment4(models.Model):
    message = models.CharField('图文评论', max_length=256)
    ascription = models.ForeignKey(PictureTextPaper, on_delete=models.CASCADE, blank=True, verbose_name='所属图文')
    register_date = models.DateTimeField('评论时间', auto_now_add=True, editable=False)
    author = models.ForeignKey(User, on_delete=models.CASCADE, blank=True, verbose_name='作者')
