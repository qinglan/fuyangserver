...
MCH_ID = "1516292141"  # 商户号
API_KEY = "1GuoyIcHuanchENgyiXUEyAnjiuyUan0"  # 微信商户平台(pay.weixin.qq.com) -->账户设置 -->API安全 -->密钥设置，设置完成后把密钥复制到这里
APP_SECRECT = "b99cf0e2eef5b8b1e8fbca5ec55f09ae"
